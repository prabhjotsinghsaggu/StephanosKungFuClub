...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-panel">
    ...
    <%--<c:forEach items="${ob}" var="ob">--%>   
        ...
        <tr><td>Rank Number</td>
            <td>${ob.rank.rank_id}</td></tr>
        <tr>
            <td>Rank Name</td>
            <td>${ob.rank.rank_name}</td></tr>
        <tr> <td>Requirement Number</td> <td>${ob.req_num}</td></tr>
                    
        <tr><td>Requirement Description</td>
            <td>${ob.req_desc}</td></tr>
