...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-panel">
    ...
    <tbody>
    <%--<c:forEach var="ob" items="${li}" >--%>                  
                    <tr>
                        <td>Student Number</td>
                        <td> ${ob.stu_num}</td></tr>
                    <tr>  
                        <td>Student Name</td>
                        <td> ${ob.stu_name} </td></tr>
                    <tr> <td>Date of Birth</td>   
                        <td> ${ob.dob} </td></tr>
                    <tr><td>Mobile Number</td>
                        <td>${ob.mob_no}</td></tr>
                    <tr><td>Joining Date</td>
                        <td> ${ob.join_date} </td></tr>
                    ...
                    <tr><td>Address</td>
                        <td> ${ob.address} </td></tr>
<!--                                       
                    <!--<tr><td><a href="showFee.com">View Fees</a></td></tr>-->
                    
                        
                       
                    <tr><td><a href="editStudent.com?sid=${ob.stu_num}">Edit Student</a></td></tr>                               
